...
class Ui_MainWindow(QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 592, 317))
        ...
        self.scrollAreaWidgetContents_4.setGeometry(QtCore.QRect(0, 0, 592, 316))
        ...
        self.gridLayout_4.addWidget(self.pushButton_2, 1, 0, 2, 1)
        ...
        self.gridLayout_4.addWidget(self.label_3, 4, 0, 3, 4)
        ...
        self.scrollAreaWidgetContents_1.setGeometry(QtCore.QRect(0, 0, 593, 662))
        ...
        self.gridLayout.addWidget(self.scrollArea_2, 0, 0, 5, 4)

        self.gridLayout.addWidget(self.label_0, 1, 4, 1, 2)

        self.gridLayout.addWidget(self.scrollArea, 2, 4, 1, 2)
        self.gridLayout.addWidget(self.scrollArea_4, 3, 4, 1, 2)
        self.gridLayout.addWidget(self.close_widget, 0, 5, 1, 1)
        ...
        self.scrollAreaWidgetContents.setWindowFlag(Qt.FramelessWindowHint)
        self.scrollAreaWidgetContents_4.setStyleSheet(sc)
        self.scrollArea_2.setWindowFlag(Qt.FramelessWindowHint)
        self.scrollArea.setWindowFlag(Qt.FramelessWindowHint)
        self.scrollArea_4.setWindowFlag(Qt.FramelessWindowHint)
    ...
    def do(self,path):
        t1 = threading.thread(target=self.__vlpr(path))
        t1.start()

    def __vlpr(self, path):
        PR = PlateRecognition()
        try:
            result = PR.get_license_plate(path)
            return result
        except:
            return
    ...
    def __show(self, result, FileName):
        ...
        self.tableWidget.item(self.RowLength - 1, 0).setForeground(QBrush(QColor(244,244,244)))

        self.tableWidget.setItem(self.RowLength - 1, 1, QTableWidgetItem(result['InputTime']))
        self.tableWidget.item(self.RowLength - 1, 1).setForeground(QBrush(QColor(244, 244, 244)))

        self.tableWidget.setItem(self.RowLength - 1, 2, QTableWidgetItem(result['Number']))
        self.tableWidget.item(self.RowLength - 1, 2).setForeground(QBrush(QColor(244, 244, 244)))

        self.tableWidget.setItem(self.RowLength - 1, 3, QTableWidgetItem(result['Type']))
        self.tableWidget.item(self.RowLength - 1, 3).setForeground(QBrush(QColor(244, 244, 244)))
        if result['Type'] == '蓝色牌照':
        ...
        self.tableWidget.item(self.RowLength - 1, 4).setForeground(QBrush(QColor(244, 244, 244)))
